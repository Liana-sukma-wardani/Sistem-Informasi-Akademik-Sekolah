...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/wallup.jpg") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="" style="color: white;">SMK Negeri 3 Mataram</a>. </strong>
      </marquee>
    </footer>
  </div>
...
@error('id_card')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Guru SMKN 3 Mataram!");
  </script>
@enderror
@error('guru')
  <script>
...
@error('no_induk')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Siswa SMKN 3 Mataram!");
  </script>
@enderror
@error('siswa')
  <script>
